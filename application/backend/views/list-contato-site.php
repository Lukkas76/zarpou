	            ...
	            <table class="table table-striped table-vcenter table-bordered table-hover js-clients">
	                <thead>
	                    <tr class="text-white bg-primary-dark">
	                    	...
	                    	<th width="10%" class="font-s12 hidden-xs hidden-sm">Telefone</th>
	                    	<th width="10%" class="font-s12">Assunto</th>
							<th width="20%">Mensagem</th>
	                    </tr>
	                </thead>
	                <tbody>
	                    <?php
	                    foreach ($contato as $key => $con):?>
	                		<tr>
	                			...
	                			<td class="font-s12"><?= $con->txtAssunto ;?></td>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(document).on('click', '#filtroData', function() {
			...
			document.location.assign('/admin/contato/list-contato-site/'+dataInicio+'/'+dataTermino)
		});
	})
</script>
