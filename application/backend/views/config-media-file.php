			...
			<div class="block block-rounded">
				<div class="items-push js-gallery-advanced">
					<div class="block-header bg-primary-dark">
	                    ...
	                    <h3 class="block-title font-w400 text-white">Dados do Projeto <small class="text-white">(clique duas vezes na ordem ou no título para alterar os dados)</small></h3>
	            	</div>
						        	...
						        	<table class="table remove-margin-b font-s12">
						        		<thead>
					                        <tr>
					                            ...
					                            <th class="font-s12 remove-padding-t text-center">Imagem de Capa?</th>
					                        </tr>
					                    </thead>
					                    <tbody>
					                        <tr data-obj="listaImagens#<?= $arq->id ?>">
					                            ...
					                            <td class="h5" style="width: 25%">
													<a href="#" id="txtTipo" data-table="Media" data-type="select" data-pk="<?=$arq->id?>" data-title="Definir o tipo de imagem" data-source="[{value: 'banner', text: 'Banner  Detalhe do Imóvel'}, {value: 'fachada', text: 'Fachada'}, {value: 'lazer', text: 'Lazer'}, {value: 'apartamento', text: 'Apartamento'}, {value: 'relacionado', text: 'Imóvel relacionado'}]"class="editable editable-click media link-effect"><?=$arq->txtTipo; ?></a>
					                            </td>
					                            <td class="text-center">
                                        			<a href="#" class="btn btn-xs btn-default" data-destaque="<?=$arq->bitCapa?>" id="" data-toggle="tooltip" title="Imagem de Capa" data-action="/admin/produto/alter-capa">
                                        			    <?= $this->template->get_icon_destaque($arq->bitCapa); ?>
                                        			</a>
					                            </td>
					                        </tr>
					                    </tbody>
