    ...
    <div class="row items-push">
        <div class="col-sm-12">
            <h1 class="page-heading text-white">
                Cadastro ou alteração dos Tipos de Plantas
            </h1>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="block block-themed" id="bloco-imovel">
                <div class="block-header bg-primary-dark">
                    ...
                    <h3 class="block-title font-w400 text-white">Tipos de plantas no Detalhe do Imóvel</h3>
                </div>
                <div class="block-content">
                    <?php
                        echo form_open('planta/new-planta', array('class'=>'js-validation-material form-horizontal push-10-t','id'=>'formImovel','method'=>'post'));
                            echo form_hidden('id', '');
                    ?>
                            <div class="form-group">
                                <div class="col-lg-5 col-xs-12">
                                    <label class="col-xs-12" for="txtPlanta">Planta</label>
                                    <div class="col-xs-12">
                                        <?php echo form_input(array('name'=> 'txtPlanta', 'required'=>'required', 'class'=>'form-control', 'type'=>'text', 'autocomplete' => 'off')); ?>
                                    </div>
                                </div>
                            ...
                            <tr data-obj="listaImovel#<?= $pro->id ?>">
                                ...
                                <td class="text-center" style="width: 10%">
                                    <div class="text-center">
                                        <div class="btn-group">
                                            <a href="#" class="btn btn-xs btn-default " data-toggle="tooltip" title="Editar Planta" data-edit="obj" data-form="#formImovel">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="#" class="btn btn-xs btn-default" data-toggle="tooltip" title="Excluir Planta" data-remove="obj">
...
<div id="dataSource" style="display: none !important;">
    <img alt="listaImovel" src="data:image/png;base64,<?= base64_encode(json_encode($planta)); ?>" />
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('[data-edit]').click(function() {
            ...
            $('#formImovel').removeAttr('action').attr('action','/admin/planta/alter-planta');
        });

        $('#cancelar').click(function() {
            $('#cancelar').addClass('hidden-print');        
            $('#formImovel').removeAttr('action').attr('action','/admin/planta/new_planta');
            $('#id').val('');
        });
    })  
    ...
    $(document).ready(function(){
        $(document).on('click', '[data-remove]', function(){
            ...
            $('.excplication').text('Tem certeza que deseja excluir uma planta do Sistema ?');
            $('#alert-modal').data('url', '/admin/planta/remove-planta');
            $('#alert-modal').data('el', $(this));
            $('.btn-action').attr('onclick' , 'excluir_planta()');
            jQuery('#alert-modal').modal('show');
            
        })
    })

    function excluir_planta(){
