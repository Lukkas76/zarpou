...
if ($_SERVER["HTTP_HOST"] == 'test01admin.000webhostapp.com'){
	$config['base_url'] = 'https://test01admin.000webhostapp.com/admin';
}
elseif ($_SERVER["HTTP_HOST"] == 'focal.Zarpou.net.br'){
	$config['base_url'] = "http://focal.Zarpou.net.br/admin";
}
elseif ($_SERVER["HTTP_HOST"] == 'www.focal.Zarpou.net.br'){
	$config['base_url'] = "http://www.focal.Zarpou.net.br/admin";
}
elseif ($_SERVER["HTTP_HOST"] == '50.116.87.55'){
	$config['base_url'] = "http://50.116.87.55/~focal029/admin";
}
elseif ($_SERVER["HTTP_HOST"] == 'homolog.focalinc.com.br'){
	$config['base_url'] = "http://homolog.focalinc.com.br/admin";
}
elseif ($_SERVER["HTTP_HOST"] == 'www.homolog.focalinc.com.br'){
	$config['base_url'] = "http://www.homolog.focalinc.com.br/admin";
}
elseif ($_SERVER["HTTP_HOST"] == 'focalinc.com.br'){
	$config['base_url'] = "http://focalinc.com.br/admin";
}
elseif ($_SERVER["HTTP_HOST"] == 'www.focalinc.com.br'){
	$config['base_url'] = "http://www.focalinc.com.br/admin";
}
